...
/>
      ...
      <Text style={styles.descriptionText}>Masukkan alamat email Anda:</Text>
      <TextInput
        style={styles.textInput}
        placeholder="Email"
        onChangeText={(text) => setEmail(text)}
      />
      <TouchableOpacity style={styles.kirimEmailButton} onPress={handleKirimEmail}> //function ada di authcontext
        <Text style={styles.buttonText}>Kirim Email</Text>
      </TouchableOpacity>
      <Text
            style={styles.kembaliText}
